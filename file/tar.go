...
func main1() {
	os.Mkdir("/home/uyun/tar", 0700)
	w, err := CopyFile("/home/uyun/tar/show.log", "/home/uyun/show.log")
	if err != nil {
		fmt.Println(err.Error())
	}
	fmt.Println(w)

	//	TarGz("/home/uyun/tar/show.log", "/home/uyun/tar/test.tar.gz") //压缩文件
	//	TarGz("/home/uyun/tar/", "/home/uyun/test.tar.gz")             //压缩目录
	UnTarGz("/home/uyun/test.tar.gz", "/home/uyun/") //解压
	//	os.RemoveAll("/home/uyun/tar")
